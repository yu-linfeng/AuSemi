...
<%@ page import="com.ausemi2.dao.CultureDao" %>
<jsp:useBean id="cultureBean" class="com.ausemi2.bean.Culture"></jsp:useBean>
        ...
        <table class="content" cellpadding="20px">
            <tr>
                <td align="left" valign="top">
                    ...
                    <div>
                        <img src="../Img/arrow_right.png">
                        <a class="hrefContentTree" href="culture.jsp" style="color:#FF0000">Ausemi Culture</a>
                    </div>
                    <div>
                        <img src="../Img/arrow_right.png">
