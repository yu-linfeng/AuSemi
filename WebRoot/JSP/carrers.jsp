...
<%@ page import="com.ausemi2.dao.CareersDao" %>
<jsp:useBean id="careersBean" class="com.ausemi2.bean.Careers"></jsp:useBean>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<%--从后台取得公司招聘信息 --%>
<%
	CareersDao careersDao = new CareersDao();
	careersBean = careersDao.find();
%>
	<!--logo-->
        ...
        <table class="content" cellpadding="20px">
            <tr >
                <td align="left" valign="top">
                    ...
                    <div>
                        <img src="../Img/arrow_right.png">
                        <a class="hrefContentTree" href="carrers.jsp" style="color:#FF0000">Careers</a>
                    </div>
                    <div>
                        <img src="../Img/arrow_right.png">
                        <a class="hrefContentTree" href="news.jsp">News Centre</a>
                    </div>
                </td>
                <td align="left">
                    <div>
                        <img src="../Img/carrers.jpg">
                    </div>
                    <div width="655" style="font-size:15px;color:#262626">
						<%=careersBean.getCareers() %>
                    </div>
                </td>
            </tr>
        </table>
