...
<%@ page import="com.ausemi2.dao.QualityDao" %>
<jsp:useBean id="qualityBean" class="com.ausemi2.bean.Quality"></jsp:useBean>
            ...
            <tr>
                <td align="left" valign="top">
                    ...
                    <div >
                        ...
                        <a class="hrefContentTree" href="about.jsp" style="font-size:16px">Company overview</a>
                    </div>
                    <div>
                        <img src="../Img/arrow_right.png">
                        <a class="hrefContentTree" href="quality.jsp" style="color:#FF0000; font-size:16px">Quality</a>
                    </div>
                    <div>
                        <img src="../Img/arrow_right.png">
